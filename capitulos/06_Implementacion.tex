...
\begin{enumerate}
    ...
    \item Reconstruir la imagen de \texttt{docker} usando el comando \\ \texttt{docker compose -f docker-compose.yml \textbackslash \\-f docker-compose.prod.yml up -{}-build}
\end{enumerate}
...
Para el caso de las agrupaciones, el flujo del usuario será:
\begin{enumerate}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{imagenes/implementacion/sentry_creando_proyecto.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{imagenes/implementacion/sentry_codigo_generado.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{imagenes/implementacion/sentry_esperando_log.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{imagenes/implementacion/sentry_log.png}

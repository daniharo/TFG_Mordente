...
Aunque ya existen herramientas como \textit{Glissandoo}, que se analiza en la sección \ref{subsection:glissandoo}, son de pago, poco personalizables o están poco integradas en el flujo de trabajo actual de las agrupaciones. Es por ello que este trabajo pretende aportar una alternativa libre que solucione estos inconvenientes, de modo que:
...
Aunque aún la mayoría de agrupaciones usan \textit{WhatsApp} como herramienta de comunicación sin utilizar ningún software más que automatice las tareas, en los últimos tiempos ha surgido otra herramienta que da respuesta a sus necesidades:

\subsection{Glissandoo}\label{subsection:glissandoo}

\textbf{Glissandoo}\footnote{\url{https://glissandoo.com/}} es un software creado por la empresa Plausible Technologies, con sede en Valencia. En su página web se define como ``un software que nace con el objetivo de profesionalizar, modernizar y digitalizar las instituciones musicales''. Incorpora numerosas funcionalidades para digitalizar instituciones musicales, tal y como pretende este trabajo. Entre ellas se encuentran:
...
\begin{itemize}
    ...
    \item Solo se puede usar en móvil, ya que no dispone de versión web ni de escritorio\footnote{Esto ha cambiado durante la realización de este trabajo, ya que se ha implementado una versión web: \url{https://glissandoo.com/blog/posts/product-update-may-22}}.
